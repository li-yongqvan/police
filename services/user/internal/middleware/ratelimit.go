...
// RateLimitByIP limits requests per client IP (fail-open if Redis unavailable).
func RateLimitByIP(rdb *redis.Client, prefix string, max int, window time.Duration) gin.HandlerFunc {
